...
| [get_ai_characters]        | 获取 Ai 声色列表     | -    | -      | ✨        | Lagrange拓展 |
| [send_group_ai_record]     | 发送群 Ai 语音       | -    | -      | ✨        | Lagrange拓展 |
...
| [fetch_custom_face]       | 获取已收藏的QQ表情列表     | -    | -      | ✨        | Lagrange拓展 |
| [get_mface_key]           | 获取mface key              | -    | -      | ✨        | Lagrange拓展 |
| [set_qq_avatar]           | 设置QQ头像                 | -    | -      | ✨        | Lagrange拓展 |
